...
17. Stage 16：状态类型安全化：新增 enum wrapper，SwiftData 仍存 String，UI/Store 收敛裸字符串。
18. Stage 17：长 SwiftUI View 拆分与组件化瘦身：不改变业务行为，提升维护性。
19. Stage 18：Prompt Library Expansion / 内置 Prompt 库扩容 ✅
20. Stage 19：Prompt Library Daily Usability Polish / Prompt 库日用体验增强 ✅
21. Stage 20：Custom Prompt Templates / 自定义 Prompt 模板增强 ✅
22. Stage 21：未来扩展 AI API、RAG、GoodNotes / NotebookLM 索引、macOS 端、云同步。
